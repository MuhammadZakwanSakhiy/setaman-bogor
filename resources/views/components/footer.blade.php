    ...
    <div class="container mx-auto px-6 grid grid-cols-1 md:grid-cols-8 gap-8 mb-12">
        <div class="md:col-span-5">
            ...
            <p class="text-gray-500 text-sm leading-relaxed max-w-xl">
                Cultivating calm in every corner. Solusi penghijauan modern untuk gaya hidup perkotaan, katalog tanaman, dan edukasi botani yang mudah diakses.
            </p>
        </div>
        <div>
        ...
        <div>
            <h4 class="font-semibold text-brand-dark mb-4">Fitur</h4>
            <ul class="space-y-2 text-sm text-brand">
                <li><a href="{{ url('/katalog') }}" class="hover:underline">Katalog</a></li>
                <li><a href="{{ url('/artikel') }}" class="hover:underline">Edukasi</a></li>
            </ul>
        </div>
        <div>
